...
public class CandleTrendPredictorController : ControllerBase
{
    ...
    private readonly ICandleTrendPredictorDataService _candleTrendPredictorDataService;

    public CandleTrendPredictorController(ICandleTrendPredictorService candleTrendPredictorService, ICandleTrendPredictorDataService candleTrendPredictorDataService)
    {
        _candleTrendPredictorService = candleTrendPredictorService;
        _candleTrendPredictorDataService = candleTrendPredictorDataService;
    }

    [HttpGet("composite-probability/{priceDifference}")]
    public IActionResult GetCompositeProbability(decimal priceDifference)
    {
        List<BinanceKlineModel> historicalData = _candleTrendPredictorDataService.GetHistoricalData();
        ...
        var PercentageOfCloseDifference = _candleTrendPredictorDataService.CalculatePercentageOfCloseDifference(priceDifference, lastClosePrice);
